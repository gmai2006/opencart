...
public class TestModelExtensionPaymentGlobalpayService  {
  @Mock
  ModelExtensionPaymentGlobalpayDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentGlobalpayServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentGlobalpayServiceImpl(dao);
  }
