...
public class TestModelExtensionPaymentFirstdataService  {
  @Mock
  ModelExtensionPaymentFirstdataDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentFirstdataServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentFirstdataServiceImpl(dao);
  }
