...
public class TestModelExtensionPaymentSkrillService  {
  @Mock
  ModelExtensionPaymentSkrillDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentSkrillServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentSkrillServiceImpl(dao);
  }
