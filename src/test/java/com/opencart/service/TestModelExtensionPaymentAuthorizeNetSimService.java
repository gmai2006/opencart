...
public class TestModelExtensionPaymentAuthorizeNetSimService  {
  @Mock
  ModelExtensionPaymentAuthorizeNetSimDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentAuthorizeNetSimServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentAuthorizeNetSimServiceImpl(dao);
  }
