...
public class TestModelCatalogProductService  {
  @Mock
  ModelCatalogProductDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelCatalogProductServiceImpl service;

  @Before
  public void before() {
    service = new ModelCatalogProductServiceImpl(dao);
  }
  ...
  public void testgetProductAttributeQuery() throws Exception {
    ...
    List<ModelCatalogProduct0Dto> list = mock(List.class);

    Integer product_id = 43;
    Integer attribute_group_id = 6;
    Integer language_id = 1;

    when(dao.getProductAttributeQuery(product_id, attribute_group_id, language_id)).thenReturn(list);
  ...
  public void testgetTotalProductSpecials() throws Exception {
    ...
    when(dao.getTotalProductSpecials(store_id, customer_group_id)).thenReturn(bean);
  ...
  public void testgetLatestProducts() throws Exception {
    ...
    when(dao.getLatestProducts(store_id)).thenReturn(list);
  ...
  public void testgetProductOptionValueQuery() throws Exception {
    ...
    List<ModelCatalogProduct1Dto> list = mock(List.class);

    Integer product_id = 42;
    Integer product_option_id = 217;
    Integer language_id = 1;

    when(dao.getProductOptionValueQuery(product_id, product_option_id, language_id)).thenReturn(list);
  ...
  public void testgetPopularProducts() throws Exception {
    ...
    when(dao.getPopularProducts(store_id)).thenReturn(list);
  ...
  public void testgetProductDiscounts() throws Exception {
    ...
    List<OcProductDiscount> list = mock(List.class);

    Integer product_id = 42;
    Integer customer_group_id = 1;

    when(dao.getProductDiscounts(product_id, customer_group_id)).thenReturn(list);
  ...
  public void testgetProfiles() throws Exception {
    ...
    List<ModelCatalogProduct2Dto> list = mock(List.class);

    Integer product_id = null;
    Integer customer_group_id = null;

    when(dao.getProfiles(product_id, customer_group_id)).thenReturn(list);
  ...
  public void testgetProfile() throws Exception {
    ...
    List<ModelCatalogProduct3Dto> list = mock(List.class);

    Integer recurring_id = null;
    Integer customer_group_id = null;

    when(dao.getProfile(recurring_id, customer_group_id)).thenReturn(list);
  ...
  public void testgetProductLayoutId() throws Exception {
    ...
    List<OcProductToLayout> list = mock(List.class);

    Integer product_id = 0;
    Integer store_id = 0;

    when(dao.getProductLayoutId(product_id, store_id)).thenReturn(list);
  ...
  public void testgetProduct() throws Exception {
    ...
    List<ModelCatalogProduct4Dto> list = mock(List.class);
    ...
    when(dao.getProduct(customer_group_id, language_id, product_id, store_id)).thenReturn(list);
  ...
  public void testgetCategories() throws Exception {
    ...
    List<OcProductToCategory> list = mock(List.class);

    Integer product_id = 1;

    when(dao.getCategories(product_id)).thenReturn(list);
  ...
  public void testgetProductAttributeGroupQuery() throws Exception {
    ...
    List<ModelCatalogProduct5Dto> list = mock(List.class);

    Integer product_id = 43;
    Integer language_id = 1;

    when(dao.getProductAttributeGroupQuery(product_id, language_id)).thenReturn(list);
  ...
  public void testgetProductImages() throws Exception {
    ...
    List<OcProductImage> list = mock(List.class);

    Integer product_id = 1;

    when(dao.getProductImages(product_id)).thenReturn(list);
  ...
  public void testgetProductOptionQuery() throws Exception {
    ...
    List<ModelCatalogProduct6Dto> list = mock(List.class);

    Integer product_id = 35;
    Integer language_id = 1;

    when(dao.getProductOptionQuery(product_id, language_id)).thenReturn(list);
  ...
  public void testgetProductRelated() throws Exception {
    ...
    List<ModelCatalogProduct7Dto> list = mock(List.class);

    Integer product_id = 42;
    Integer store_id = 0;

    when(dao.getProductRelated(product_id, store_id)).thenReturn(list);
  ...
  public void testgetBestSellerProducts() throws Exception {
    ...
    List<ModelCatalogProduct8Dto> list = mock(List.class);

    Integer store_id = null;

    when(dao.getBestSellerProducts(store_id)).thenReturn(list);
