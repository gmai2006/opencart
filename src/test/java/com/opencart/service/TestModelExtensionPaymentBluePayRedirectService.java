...
public class TestModelExtensionPaymentBluePayRedirectService  {
  @Mock
  ModelExtensionPaymentBluePayRedirectDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentBluePayRedirectServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentBluePayRedirectServiceImpl(dao);
  }
