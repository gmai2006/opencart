...
public class TestModelExtensionPaymentPPStandardService  {
  @Mock
  ModelExtensionPaymentPPStandardDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentPPStandardServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentPPStandardServiceImpl(dao);
  }
