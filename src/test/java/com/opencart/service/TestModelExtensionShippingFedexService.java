...
public class TestModelExtensionShippingFedexService  {
  @Mock
  ModelExtensionShippingFedexDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionShippingFedexServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionShippingFedexServiceImpl(dao);
  }
