...
public class TestModelExtensionPaymentKlarnaAccountService  {
  @Mock
  ModelExtensionPaymentKlarnaAccountDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentKlarnaAccountServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentKlarnaAccountServiceImpl(dao);
  }
