...
public class TestModelExtensionPaymentPPExpressService  {
  @Mock
  ModelExtensionPaymentPPExpressDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentPPExpressServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentPPExpressServiceImpl(dao);
  }
