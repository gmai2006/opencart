...
public class TestModelExtensionPaymentSagePayDirectService  {
  @Mock
  ModelExtensionPaymentSagePayDirectDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentSagePayDirectServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentSagePayDirectServiceImpl(dao);
  }
