...
public class TestModelExtensionPaymentPayMateService  {
  @Mock
  ModelExtensionPaymentPayMateDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentPayMateServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentPayMateServiceImpl(dao);
  }
