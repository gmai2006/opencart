...
public class TestModelExtensionPaymentKlarnaInvoiceService  {
  @Mock
  ModelExtensionPaymentKlarnaInvoiceDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentKlarnaInvoiceServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentKlarnaInvoiceServiceImpl(dao);
  }
