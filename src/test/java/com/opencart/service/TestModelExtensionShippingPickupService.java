...
public class TestModelExtensionShippingPickupService  {
  @Mock
  ModelExtensionShippingPickupDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionShippingPickupServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionShippingPickupServiceImpl(dao);
  }
