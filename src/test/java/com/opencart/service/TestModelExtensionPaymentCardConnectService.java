...
public class TestModelExtensionPaymentCardConnectService  {
  @Mock
  ModelExtensionPaymentCardConnectDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentCardConnectServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentCardConnectServiceImpl(dao);
  }
