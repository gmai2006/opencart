...
public class TestModelExtensionPaymentSecureTradingPpService  {
  @Mock
  ModelExtensionPaymentSecureTradingPpDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentSecureTradingPpServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentSecureTradingPpServiceImpl(dao);
  }
