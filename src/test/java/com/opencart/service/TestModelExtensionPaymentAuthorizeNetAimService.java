...
public class TestModelExtensionPaymentAuthorizeNetAimService  {
  @Mock
  ModelExtensionPaymentAuthorizeNetAimDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentAuthorizeNetAimServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentAuthorizeNetAimServiceImpl(dao);
  }
