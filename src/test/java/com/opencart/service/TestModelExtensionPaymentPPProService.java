...
public class TestModelExtensionPaymentPPProService  {
  @Mock
  ModelExtensionPaymentPPProDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentPPProServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentPPProServiceImpl(dao);
  }
