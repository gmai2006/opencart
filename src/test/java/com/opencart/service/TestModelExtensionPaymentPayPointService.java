...
public class TestModelExtensionPaymentPayPointService  {
  @Mock
  ModelExtensionPaymentPayPointDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentPayPointServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentPayPointServiceImpl(dao);
  }
