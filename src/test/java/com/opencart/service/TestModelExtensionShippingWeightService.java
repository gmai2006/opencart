...
public class TestModelExtensionShippingWeightService  {
  @Mock
  ModelExtensionShippingWeightDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionShippingWeightServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionShippingWeightServiceImpl(dao);
  }
