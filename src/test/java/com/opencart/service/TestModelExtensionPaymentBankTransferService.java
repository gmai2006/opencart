...
public class TestModelExtensionPaymentBankTransferService  {
  @Mock
  ModelExtensionPaymentBankTransferDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentBankTransferServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentBankTransferServiceImpl(dao);
  }
