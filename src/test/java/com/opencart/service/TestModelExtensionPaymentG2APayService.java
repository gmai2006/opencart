...
public class TestModelExtensionPaymentG2APayService  {
  @Mock
  ModelExtensionPaymentG2APayDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentG2APayServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentG2APayServiceImpl(dao);
  }
