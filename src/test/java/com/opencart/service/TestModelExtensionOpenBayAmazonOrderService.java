...
public class TestModelExtensionOpenBayAmazonOrderService  {
  @Mock
  ModelExtensionOpenBayAmazonOrderDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionOpenBayAmazonOrderServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionOpenBayAmazonOrderServiceImpl(dao);
  }
  ...
  public void testgetProductOptionsByVar() throws Exception {
    ...
    List<ModelExtensionOpenBayAmazonOrder0Dto> list = mock(List.class);
    ...
    List<ModelExtensionOpenBayAmazonOrder0Dto> result = dao.getProductOptionsByVar(product_option_value_id, language_id);
   ...
   */
  @Test
  public void testaddAmazonOrderProducts() throws Exception {
    ...
    when(dao.addAmazonOrderProducts(model, order_id)).thenReturn(list);

    List<Integer> result = dao.addAmazonOrderProducts(model, order_id);
