...
public class TestModelExtensionPaymentWebPaymentSoftwareService  {
  @Mock
  ModelExtensionPaymentWebPaymentSoftwareDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentWebPaymentSoftwareServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentWebPaymentSoftwareServiceImpl(dao);
  }
