...
public class TestModelExtensionPaymentNOCHEXService  {
  @Mock
  ModelExtensionPaymentNOCHEXDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentNOCHEXServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentNOCHEXServiceImpl(dao);
  }
