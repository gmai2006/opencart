...
public class TestModelExtensionPaymentCODService  {
  @Mock
  ModelExtensionPaymentCODDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentCODServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentCODServiceImpl(dao);
  }
