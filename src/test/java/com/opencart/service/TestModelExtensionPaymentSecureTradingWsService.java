...
public class TestModelExtensionPaymentSecureTradingWsService  {
  @Mock
  ModelExtensionPaymentSecureTradingWsDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentSecureTradingWsServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentSecureTradingWsServiceImpl(dao);
  }
