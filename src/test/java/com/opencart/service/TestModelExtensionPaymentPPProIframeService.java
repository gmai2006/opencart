...
public class TestModelExtensionPaymentPPProIframeService  {
  @Mock
  ModelExtensionPaymentPPProIframeDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentPPProIframeServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentPPProIframeServiceImpl(dao);
  }
