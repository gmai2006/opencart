...
public class TestModelExtensionShippingRoyalMailService  {
  @Mock
  ModelExtensionShippingRoyalMailDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionShippingRoyalMailServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionShippingRoyalMailServiceImpl(dao);
  }
