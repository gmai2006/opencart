...
public class TestModelExtensionShippingUspsService  {
  @Mock
  ModelExtensionShippingUspsDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionShippingUspsServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionShippingUspsServiceImpl(dao);
  }
