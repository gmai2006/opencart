...
public class TestModelExtensionPaymentPPPayflowIframeService  {
  @Mock
  ModelExtensionPaymentPPPayflowIframeDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentPPPayflowIframeServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentPPPayflowIframeServiceImpl(dao);
  }
