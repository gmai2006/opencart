...
public class TestModelExtensionPaymentBluePayHostedService  {
  @Mock
  ModelExtensionPaymentBluePayHostedDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentBluePayHostedServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentBluePayHostedServiceImpl(dao);
  }
