...
public class TestModelExtensionPaymentPPPayflowService  {
  @Mock
  ModelExtensionPaymentPPPayflowDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentPPPayflowServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentPPPayflowServiceImpl(dao);
  }
