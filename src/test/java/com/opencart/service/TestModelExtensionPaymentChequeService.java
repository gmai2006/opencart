...
public class TestModelExtensionPaymentChequeService  {
  @Mock
  ModelExtensionPaymentChequeDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentChequeServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentChequeServiceImpl(dao);
  }
