...
public class TestModelExtensionShippingItemService  {
  @Mock
  ModelExtensionShippingItemDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionShippingItemServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionShippingItemServiceImpl(dao);
  }
