...
public class TestModelExtensionShippingCitylinkService  {
  @Mock
  ModelExtensionShippingCitylinkDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionShippingCitylinkServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionShippingCitylinkServiceImpl(dao);
  }
