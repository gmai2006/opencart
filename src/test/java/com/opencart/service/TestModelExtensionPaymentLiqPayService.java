...
public class TestModelExtensionPaymentLiqPayService  {
  @Mock
  ModelExtensionPaymentLiqPayDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentLiqPayServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentLiqPayServiceImpl(dao);
  }
