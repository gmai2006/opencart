...
public class TestModelExtensionPaymentSagePayUSService  {
  @Mock
  ModelExtensionPaymentSagePayUSDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentSagePayUSServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentSagePayUSServiceImpl(dao);
  }
