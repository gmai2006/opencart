...
public class TestModelExtensionPaymentFirstdataRemoteService  {
  @Mock
  ModelExtensionPaymentFirstdataRemoteDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentFirstdataRemoteServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentFirstdataRemoteServiceImpl(dao);
  }
