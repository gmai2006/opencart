...
public class TestModelExtensionPaymentCardinityService  {
  @Mock
  ModelExtensionPaymentCardinityDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentCardinityServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentCardinityServiceImpl(dao);
  }
