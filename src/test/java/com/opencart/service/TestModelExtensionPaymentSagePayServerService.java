...
public class TestModelExtensionPaymentSagePayServerService  {
  @Mock
  ModelExtensionPaymentSagePayServerDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentSagePayServerServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentSagePayServerServiceImpl(dao);
  }
  ...
  public void testgetProfile() throws Exception {
    ...
    when(dao.getProfile(order_recurring_id)).thenReturn(list);
  ...
  public void testgetRecurringOrders() throws Exception {
    ...
    when(dao.getRecurringOrders(order_id)).thenReturn(list);

    List<OcOrderRecurring> result = dao.getRecurringOrders(order_id);
