...
public class TestModelExtensionShippingFlatService  {
  @Mock
  ModelExtensionShippingFlatDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionShippingFlatServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionShippingFlatServiceImpl(dao);
  }
