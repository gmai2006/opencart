...
public class TestModelExtensionShippingFreeService  {
  @Mock
  ModelExtensionShippingFreeDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionShippingFreeServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionShippingFreeServiceImpl(dao);
  }
