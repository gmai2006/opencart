...
public class TestModelExtensionPaymentRealexService  {
  @Mock
  ModelExtensionPaymentRealexDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentRealexServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentRealexServiceImpl(dao);
  }
