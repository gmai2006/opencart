...
public class TestModelExtensionPaymentEwayService  {
  @Mock
  ModelExtensionPaymentEwayDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentEwayServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentEwayServiceImpl(dao);
  }
