...
public class TestModelExtensionPaymentLaybuyService  {
  @Mock
  ModelExtensionPaymentLaybuyDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentLaybuyServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentLaybuyServiceImpl(dao);
  }
  ...
  public void testgetQuery() throws Exception {
    ...
    when(dao.getQuery(geo_zone_id, country_id)).thenReturn(list);
  ...
  public void testgetProduct() throws Exception {
    String bean = mock(String.class);

    Integer product_id = 1;

    when(dao.getProduct(product_id)).thenReturn(bean);
