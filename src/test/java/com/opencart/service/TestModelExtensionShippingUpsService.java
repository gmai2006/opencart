...
public class TestModelExtensionShippingUpsService  {
  @Mock
  ModelExtensionShippingUpsDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionShippingUpsServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionShippingUpsServiceImpl(dao);
  }
