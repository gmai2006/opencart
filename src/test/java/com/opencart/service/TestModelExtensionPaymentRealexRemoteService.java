...
public class TestModelExtensionPaymentRealexRemoteService  {
  @Mock
  ModelExtensionPaymentRealexRemoteDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentRealexRemoteServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentRealexRemoteServiceImpl(dao);
  }
