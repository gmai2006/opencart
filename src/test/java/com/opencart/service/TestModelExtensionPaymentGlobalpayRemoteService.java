...
public class TestModelExtensionPaymentGlobalpayRemoteService  {
  @Mock
  ModelExtensionPaymentGlobalpayRemoteDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentGlobalpayRemoteServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentGlobalpayRemoteServiceImpl(dao);
  }
