...
public class TestModelExtensionShippingAusPostService  {
  @Mock
  ModelExtensionShippingAusPostDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionShippingAusPostServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionShippingAusPostServiceImpl(dao);
  }
