...
public class TestModelExtensionPaymentTwoCheckoutService  {
  @Mock
  ModelExtensionPaymentTwoCheckoutDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentTwoCheckoutServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentTwoCheckoutServiceImpl(dao);
  }
