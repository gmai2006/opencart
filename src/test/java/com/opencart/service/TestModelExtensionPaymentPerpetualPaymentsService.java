...
public class TestModelExtensionPaymentPerpetualPaymentsService  {
  @Mock
  ModelExtensionPaymentPerpetualPaymentsDao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionPaymentPerpetualPaymentsServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionPaymentPerpetualPaymentsServiceImpl(dao);
  }
