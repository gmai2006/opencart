...
public class TestModelExtensionShippingParcelforce48Service  {
  @Mock
  ModelExtensionShippingParcelforce48Dao dao;

  @Rule
  public MockitoRule mockitoRule = MockitoJUnit.rule();

  ModelExtensionShippingParcelforce48ServiceImpl service;

  @Before
  public void before() {
    service = new ModelExtensionShippingParcelforce48ServiceImpl(dao);
  }
  ...
  public void testgetQuote() throws Exception {
    ...
    when(dao.getQuote(geo_zone_id, country_id)).thenReturn(list);
