...
public class TestModelExtensionPaymentPPPayflowIframeDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentPPPayflowIframeDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentPPPayflowIframeDaoImpl.class);
        }
    };
  }
