...
public class TestModelExtensionPaymentLiqPayDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentLiqPayDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentLiqPayDaoImpl.class);
        }
    };
  }
