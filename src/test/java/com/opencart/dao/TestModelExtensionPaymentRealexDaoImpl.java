...
public class TestModelExtensionPaymentRealexDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentRealexDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentRealexDaoImpl.class);
        }
    };
  }
