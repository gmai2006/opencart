...
public class TestModelExtensionPaymentSecureTradingPpDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentSecureTradingPpDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentSecureTradingPpDaoImpl.class);
        }
    };
  }
