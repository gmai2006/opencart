...
public class TestModelExtensionPaymentBankTransferDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentBankTransferDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentBankTransferDaoImpl.class);
        }
    };
  }
