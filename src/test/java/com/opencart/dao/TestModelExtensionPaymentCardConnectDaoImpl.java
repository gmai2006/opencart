...
public class TestModelExtensionPaymentCardConnectDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentCardConnectDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentCardConnectDaoImpl.class);
        }
    };
  }
