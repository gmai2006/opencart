...
public class TestModelExtensionPaymentSagePayUSDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentSagePayUSDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentSagePayUSDaoImpl.class);
        }
    };
  }
