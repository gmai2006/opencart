...
public class TestModelExtensionPaymentPPStandardDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentPPStandardDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentPPStandardDaoImpl.class);
        }
    };
  }
