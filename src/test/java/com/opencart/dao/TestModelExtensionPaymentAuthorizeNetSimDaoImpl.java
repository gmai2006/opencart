...
public class TestModelExtensionPaymentAuthorizeNetSimDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentAuthorizeNetSimDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentAuthorizeNetSimDaoImpl.class);
        }
    };
  }
