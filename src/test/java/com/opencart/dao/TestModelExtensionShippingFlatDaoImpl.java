...
public class TestModelExtensionShippingFlatDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionShippingFlatDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionShippingFlatDaoImpl.class);
        }
    };
  }
