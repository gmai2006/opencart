...
public class TestModelExtensionShippingFreeDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionShippingFreeDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionShippingFreeDaoImpl.class);
        }
    };
  }
