...
public class TestModelExtensionShippingCitylinkDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionShippingCitylinkDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionShippingCitylinkDaoImpl.class);
        }
    };
  }
