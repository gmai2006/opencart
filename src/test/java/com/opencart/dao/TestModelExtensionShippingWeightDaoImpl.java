...
public class TestModelExtensionShippingWeightDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionShippingWeightDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionShippingWeightDaoImpl.class);
        }
    };
  }
