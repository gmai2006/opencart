...
public class TestModelExtensionPaymentPPProDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentPPProDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentPPProDaoImpl.class);
        }
    };
  }
