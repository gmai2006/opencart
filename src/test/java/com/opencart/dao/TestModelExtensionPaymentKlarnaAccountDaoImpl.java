...
public class TestModelExtensionPaymentKlarnaAccountDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentKlarnaAccountDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentKlarnaAccountDaoImpl.class);
        }
    };
  }
