...
public class TestModelExtensionPaymentNOCHEXDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentNOCHEXDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentNOCHEXDaoImpl.class);
        }
    };
  }
