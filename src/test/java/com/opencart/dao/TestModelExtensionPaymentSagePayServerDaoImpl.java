...
public class TestModelExtensionPaymentSagePayServerDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentSagePayServerDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentSagePayServerDaoImpl.class);
        }
    };
  }
  ...
  public void testgetRecurringOrders() throws Exception {
    ...
    assertThat("getRecurringOrders", result, notNullValue());
  }
}