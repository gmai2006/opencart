...
public class TestModelExtensionPaymentWebPaymentSoftwareDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentWebPaymentSoftwareDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentWebPaymentSoftwareDaoImpl.class);
        }
    };
  }
