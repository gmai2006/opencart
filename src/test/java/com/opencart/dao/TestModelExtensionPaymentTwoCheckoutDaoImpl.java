...
public class TestModelExtensionPaymentTwoCheckoutDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentTwoCheckoutDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentTwoCheckoutDaoImpl.class);
        }
    };
  }
