...
public class TestModelExtensionPaymentPerpetualPaymentsDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentPerpetualPaymentsDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentPerpetualPaymentsDaoImpl.class);
        }
    };
  }
