...
public class TestModelExtensionPaymentFirstdataDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentFirstdataDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentFirstdataDaoImpl.class);
        }
    };
  }
