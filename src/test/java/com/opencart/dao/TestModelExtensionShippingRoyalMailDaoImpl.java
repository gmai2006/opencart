...
public class TestModelExtensionShippingRoyalMailDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionShippingRoyalMailDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionShippingRoyalMailDaoImpl.class);
        }
    };
  }
