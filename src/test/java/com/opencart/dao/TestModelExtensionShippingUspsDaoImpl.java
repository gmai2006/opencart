...
public class TestModelExtensionShippingUspsDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionShippingUspsDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionShippingUspsDaoImpl.class);
        }
    };
  }
