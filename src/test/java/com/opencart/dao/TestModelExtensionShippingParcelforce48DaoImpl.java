...
public class TestModelExtensionShippingParcelforce48DaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionShippingParcelforce48DaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionShippingParcelforce48DaoImpl.class);
        }
    };
  }
