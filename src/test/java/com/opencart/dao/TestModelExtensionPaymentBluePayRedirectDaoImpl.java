...
public class TestModelExtensionPaymentBluePayRedirectDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentBluePayRedirectDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentBluePayRedirectDaoImpl.class);
        }
    };
  }
