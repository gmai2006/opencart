...
public class TestModelExtensionPaymentWorldpayDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentWorldpayDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentWorldpayDaoImpl.class);
        }
    };
  }
