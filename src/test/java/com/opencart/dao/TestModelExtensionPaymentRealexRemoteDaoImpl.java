...
public class TestModelExtensionPaymentRealexRemoteDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentRealexRemoteDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentRealexRemoteDaoImpl.class);
        }
    };
  }
