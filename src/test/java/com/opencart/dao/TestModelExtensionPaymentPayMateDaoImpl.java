...
public class TestModelExtensionPaymentPayMateDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentPayMateDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentPayMateDaoImpl.class);
        }
    };
  }
