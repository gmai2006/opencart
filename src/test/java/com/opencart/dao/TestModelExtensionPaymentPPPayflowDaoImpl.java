...
public class TestModelExtensionPaymentPPPayflowDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentPPPayflowDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentPPPayflowDaoImpl.class);
        }
    };
  }
