...
public class TestModelExtensionPaymentG2APayDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentG2APayDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentG2APayDaoImpl.class);
        }
    };
  }
