...
public class TestModelExtensionShippingUpsDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionShippingUpsDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionShippingUpsDaoImpl.class);
        }
    };
  }
