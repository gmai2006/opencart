...
public class TestModelExtensionPaymentEwayDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentEwayDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentEwayDaoImpl.class);
        }
    };
  }
