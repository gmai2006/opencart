...
public class TestModelExtensionPaymentGlobalpayRemoteDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentGlobalpayRemoteDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentGlobalpayRemoteDaoImpl.class);
        }
    };
  }
