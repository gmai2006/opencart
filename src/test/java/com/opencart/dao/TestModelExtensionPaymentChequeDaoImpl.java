...
public class TestModelExtensionPaymentChequeDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentChequeDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentChequeDaoImpl.class);
        }
    };
  }
