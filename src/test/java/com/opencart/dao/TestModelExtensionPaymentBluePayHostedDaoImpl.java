...
public class TestModelExtensionPaymentBluePayHostedDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentBluePayHostedDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentBluePayHostedDaoImpl.class);
        }
    };
  }
