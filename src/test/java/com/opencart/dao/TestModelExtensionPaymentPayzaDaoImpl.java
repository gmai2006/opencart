...
public class TestModelExtensionPaymentPayzaDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentPayzaDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentPayzaDaoImpl.class);
        }
    };
  }
