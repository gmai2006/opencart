...
public class TestModelExtensionShippingAusPostDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionShippingAusPostDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionShippingAusPostDaoImpl.class);
        }
    };
  }
