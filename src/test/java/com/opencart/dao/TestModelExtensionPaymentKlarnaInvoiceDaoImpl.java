...
public class TestModelExtensionPaymentKlarnaInvoiceDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentKlarnaInvoiceDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentKlarnaInvoiceDaoImpl.class);
        }
    };
  }
