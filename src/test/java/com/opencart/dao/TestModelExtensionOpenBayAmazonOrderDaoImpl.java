...
public class TestModelExtensionOpenBayAmazonOrderDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionOpenBayAmazonOrderDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionOpenBayAmazonOrderDaoImpl.class);
        }
    };
  }
  ...
  public void testaddAmazonOrderProducts() throws Exception {
    ...
    assertThat("addAmazonOrderProducts", result, notNullValue());
  }
