...
public class TestModelExtensionPaymentAuthorizeNetAimDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentAuthorizeNetAimDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentAuthorizeNetAimDaoImpl.class);
        }
    };
  }
