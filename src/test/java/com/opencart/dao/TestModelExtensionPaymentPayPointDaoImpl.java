...
public class TestModelExtensionPaymentPayPointDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentPayPointDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentPayPointDaoImpl.class);
        }
    };
  }
