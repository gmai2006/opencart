...
public class TestModelDesignTranslationDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelDesignTranslationDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelDesignTranslationDaoImpl.class);
        }
    };
  }
  ...
  public void testgetTranslations() throws Exception {
    ...
    assertThat("getTranslations", result, notNullValue());
  }
}