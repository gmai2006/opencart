...
public class TestModelExtensionShippingItemDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionShippingItemDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionShippingItemDaoImpl.class);
        }
    };
  }
