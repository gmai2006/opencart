...
public class TestModelExtensionPaymentFirstdataRemoteDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentFirstdataRemoteDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentFirstdataRemoteDaoImpl.class);
        }
    };
  }
