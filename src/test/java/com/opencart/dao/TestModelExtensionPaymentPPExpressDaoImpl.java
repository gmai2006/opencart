...
public class TestModelExtensionPaymentPPExpressDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentPPExpressDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentPPExpressDaoImpl.class);
        }
    };
  }
