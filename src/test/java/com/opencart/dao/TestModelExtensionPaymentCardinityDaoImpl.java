...
public class TestModelExtensionPaymentCardinityDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentCardinityDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentCardinityDaoImpl.class);
        }
    };
  }
