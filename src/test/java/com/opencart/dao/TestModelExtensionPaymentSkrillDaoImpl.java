...
public class TestModelExtensionPaymentSkrillDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentSkrillDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentSkrillDaoImpl.class);
        }
    };
  }
