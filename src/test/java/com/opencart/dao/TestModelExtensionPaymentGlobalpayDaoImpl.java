...
public class TestModelExtensionPaymentGlobalpayDaoImpl extends GoogleGuiceTest {

  @Inject
  ModelExtensionPaymentGlobalpayDaoImpl dao;
  ...
  protected Module getTestModule() {
    return new AbstractModule() {
        ...
        protected void configure() {
            bind(ModelExtensionPaymentGlobalpayDaoImpl.class);
        }
    };
  }
