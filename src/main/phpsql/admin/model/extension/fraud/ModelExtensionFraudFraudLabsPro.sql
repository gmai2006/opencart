install1=$this->db->query("INSERT INTO `".DB_PREFIX."order_status` (`language_id`, `name`) VALUES (1, 'Fraud');")
#END
install2=$this->db->query("INSERT INTO `".DB_PREFIX."order_status` (`language_id`, `name`) VALUES (1, 'Fraud Review');")
#END
uninstall1=$this->db->query("DELETE FROM `".DB_PREFIX."order_status` WHERE `name` = 'Fraud Review'")
#END
uninstall=$this->db->query("DELETE FROM `".DB_PREFIX."order_status` WHERE `name` = 'Fraud'")
#END
install=$this->db->query("
		...
		")
#END
getOrder=$this->db->query("SELECT * FROM `".DB_PREFIX."fraudlabspro` WHERE order_id = '".(int)$order_id."'")
#END
install7=$this->db->query("INSERT INTO `".DB_PREFIX."setting` (`code`, `key`, `value`, `serialized`) VALUES ('fraudlabspro', 'fraudlabspro_reject_status_id', '8', '0');")
#END
install5=$this->db->query("INSERT INTO `".DB_PREFIX."setting` (`code`, `key`, `value`, `serialized`) VALUES ('fraudlabspro', 'fraudlabspro_review_status_id', '$status_fraud_review_id', '0');")
#END
install6=$this->db->query("INSERT INTO `".DB_PREFIX."setting` (`code`, `key`, `value`, `serialized`) VALUES ('fraudlabspro', 'fraudlabspro_approve_status_id', '2', '0');")
#END
install3=$this->db->query("INSERT INTO `".DB_PREFIX."setting` (`code`, `key`, `value`, `serialized`) VALUES ('fraudlabspro', 'fraudlabspro_score', '80', '0');")
#END
install4=$this->db->query("INSERT INTO `".DB_PREFIX."setting` (`code`, `key`, `value`, `serialized`) VALUES ('fraudlabspro', 'fraudlabspro_order_status_id', '$status_fraud_id', '0');")
#END
