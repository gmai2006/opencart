...
*/
public class OcReturnReasonServiceImpl implements OcReturnReasonService {
private final Logger logger = Logger.getLogger(this.getClass().getName());

  private final OcReturnReasonDao dao;

  @Inject
  protected OcReturnReasonServiceImpl(final OcReturnReasonDao dao) {
      requireNonNull(dao);
      this.dao = dao;
  }
  ...
  public List<OcReturnReason> selectAll() {
      final List<OcReturnReason> result = dao.selectAll();
      logger.info("selectAll(OcReturnReason) - exited - return value={} result ");
      return result;
  }
  ...
  @Override
  @Transactional
  public void delete(OcReturnReason bean) {
    logger.info("delete(OcReturnReason={}) - entered bean");

    dao.delete(bean);

    logger.info("delete(OcReturnReason) - exited - return value={} result ");
  }
}