...
*/
public class OcTaxClassServiceImpl implements OcTaxClassService {
private final Logger logger = Logger.getLogger(this.getClass().getName());

  private final OcTaxClassDao dao;

  @Inject
  protected OcTaxClassServiceImpl(final OcTaxClassDao dao) {
      requireNonNull(dao);
      this.dao = dao;
  }
  ...
  public List<OcTaxClass> selectAll() {
      final List<OcTaxClass> result = dao.selectAll();
      logger.info("selectAll(OcTaxClass) - exited - return value={} result ");
      return result;
  }
  ...
  @Override
  @Transactional
  public void delete(OcTaxClass bean) {
    logger.info("delete(OcTaxClass={}) - entered bean");

    dao.delete(bean);

    logger.info("delete(OcTaxClass) - exited - return value={} result ");
  }
}