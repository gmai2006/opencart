...
*/
public class OcCustomFieldCustomerGroupServiceImpl implements OcCustomFieldCustomerGroupService {
private final Logger logger = Logger.getLogger(this.getClass().getName());

  private final OcCustomFieldCustomerGroupDao dao;

  @Inject
  protected OcCustomFieldCustomerGroupServiceImpl(final OcCustomFieldCustomerGroupDao dao) {
      requireNonNull(dao);
      this.dao = dao;
  }
  ...
  public List<OcCustomFieldCustomerGroup> selectAll() {
      final List<OcCustomFieldCustomerGroup> result = dao.selectAll();
      logger.info("selectAll(OcCustomFieldCustomerGroup) - exited - return value={} result ");
      return result;
  }
  ...
  @Override
  @Transactional
  public void delete(OcCustomFieldCustomerGroup bean) {
    logger.info("delete(OcCustomFieldCustomerGroup={}) - entered bean");

    dao.delete(bean);

    logger.info("delete(OcCustomFieldCustomerGroup) - exited - return value={} result ");
  }
}