...
*/
public class OcProductRelatedServiceImpl implements OcProductRelatedService {
private final Logger logger = Logger.getLogger(this.getClass().getName());

  private final OcProductRelatedDao dao;

  @Inject
  protected OcProductRelatedServiceImpl(final OcProductRelatedDao dao) {
      requireNonNull(dao);
      this.dao = dao;
  }
  ...
  public List<OcProductRelated> selectAll() {
      final List<OcProductRelated> result = dao.selectAll();
      logger.info("selectAll(OcProductRelated) - exited - return value={} result ");
      return result;
  }
  ...
  @Override
  @Transactional
  public void delete(OcProductRelated bean) {
    logger.info("delete(OcProductRelated={}) - entered bean");

    dao.delete(bean);

    logger.info("delete(OcProductRelated) - exited - return value={} result ");
  }
}