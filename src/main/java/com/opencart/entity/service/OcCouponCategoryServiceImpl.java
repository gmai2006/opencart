...
*/
public class OcCouponCategoryServiceImpl implements OcCouponCategoryService {
private final Logger logger = Logger.getLogger(this.getClass().getName());

  private final OcCouponCategoryDao dao;

  @Inject
  protected OcCouponCategoryServiceImpl(final OcCouponCategoryDao dao) {
      requireNonNull(dao);
      this.dao = dao;
  }
  ...
  public List<OcCouponCategory> selectAll() {
      final List<OcCouponCategory> result = dao.selectAll();
      logger.info("selectAll(OcCouponCategory) - exited - return value={} result ");
      return result;
  }
  ...
  @Override
  @Transactional
  public void delete(OcCouponCategory bean) {
    logger.info("delete(OcCouponCategory={}) - entered bean");

    dao.delete(bean);

    logger.info("delete(OcCouponCategory) - exited - return value={} result ");
  }
}