...
*/
public class OcLayoutRouteServiceImpl implements OcLayoutRouteService {
private final Logger logger = Logger.getLogger(this.getClass().getName());

  private final OcLayoutRouteDao dao;

  @Inject
  protected OcLayoutRouteServiceImpl(final OcLayoutRouteDao dao) {
      requireNonNull(dao);
      this.dao = dao;
  }
  ...
  public List<OcLayoutRoute> selectAll() {
      final List<OcLayoutRoute> result = dao.selectAll();
      logger.info("selectAll(OcLayoutRoute) - exited - return value={} result ");
      return result;
  }
  ...
  @Override
  @Transactional
  public void delete(OcLayoutRoute bean) {
    logger.info("delete(OcLayoutRoute={}) - entered bean");

    dao.delete(bean);

    logger.info("delete(OcLayoutRoute) - exited - return value={} result ");
  }
}