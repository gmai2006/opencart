...
*/
public class OcCustomerSearchServiceImpl implements OcCustomerSearchService {
private final Logger logger = Logger.getLogger(this.getClass().getName());

  private final OcCustomerSearchDao dao;

  @Inject
  protected OcCustomerSearchServiceImpl(final OcCustomerSearchDao dao) {
      requireNonNull(dao);
      this.dao = dao;
  }
  ...
  public List<OcCustomerSearch> selectAll() {
      final List<OcCustomerSearch> result = dao.selectAll();
      logger.info("selectAll(OcCustomerSearch) - exited - return value={} result ");
      return result;
  }
  ...
  @Override
  @Transactional
  public void delete(OcCustomerSearch bean) {
    logger.info("delete(OcCustomerSearch={}) - entered bean");

    dao.delete(bean);

    logger.info("delete(OcCustomerSearch) - exited - return value={} result ");
  }
}