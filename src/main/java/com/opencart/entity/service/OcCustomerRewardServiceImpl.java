...
*/
public class OcCustomerRewardServiceImpl implements OcCustomerRewardService {
private final Logger logger = Logger.getLogger(this.getClass().getName());

  private final OcCustomerRewardDao dao;

  @Inject
  protected OcCustomerRewardServiceImpl(final OcCustomerRewardDao dao) {
      requireNonNull(dao);
      this.dao = dao;
  }
  ...
  public List<OcCustomerReward> selectAll() {
      final List<OcCustomerReward> result = dao.selectAll();
      logger.info("selectAll(OcCustomerReward) - exited - return value={} result ");
      return result;
  }
  ...
  @Override
  @Transactional
  public void delete(OcCustomerReward bean) {
    logger.info("delete(OcCustomerReward={}) - entered bean");

    dao.delete(bean);

    logger.info("delete(OcCustomerReward) - exited - return value={} result ");
  }
}