...
*/
public class OcCustomFieldDescriptionServiceImpl implements OcCustomFieldDescriptionService {
private final Logger logger = Logger.getLogger(this.getClass().getName());

  private final OcCustomFieldDescriptionDao dao;

  @Inject
  protected OcCustomFieldDescriptionServiceImpl(final OcCustomFieldDescriptionDao dao) {
      requireNonNull(dao);
      this.dao = dao;
  }
  ...
  public List<OcCustomFieldDescription> selectAll() {
      final List<OcCustomFieldDescription> result = dao.selectAll();
      logger.info("selectAll(OcCustomFieldDescription) - exited - return value={} result ");
      return result;
  }
  ...
  @Override
  @Transactional
  public void delete(OcCustomFieldDescription bean) {
    logger.info("delete(OcCustomFieldDescription={}) - entered bean");

    dao.delete(bean);

    logger.info("delete(OcCustomFieldDescription) - exited - return value={} result ");
  }
}