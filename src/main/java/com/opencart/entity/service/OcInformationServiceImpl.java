...
*/
public class OcInformationServiceImpl implements OcInformationService {
private final Logger logger = Logger.getLogger(this.getClass().getName());

  private final OcInformationDao dao;

  @Inject
  protected OcInformationServiceImpl(final OcInformationDao dao) {
      requireNonNull(dao);
      this.dao = dao;
  }
  ...
  public List<OcInformation> selectAll() {
      final List<OcInformation> result = dao.selectAll();
      logger.info("selectAll(OcInformation) - exited - return value={} result ");
      return result;
  }
  ...
  @Override
  @Transactional
  public void delete(OcInformation bean) {
    logger.info("delete(OcInformation={}) - entered bean");

    dao.delete(bean);

    logger.info("delete(OcInformation) - exited - return value={} result ");
  }
}