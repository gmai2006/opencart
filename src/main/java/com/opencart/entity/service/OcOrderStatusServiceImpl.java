...
*/
public class OcOrderStatusServiceImpl implements OcOrderStatusService {
private final Logger logger = Logger.getLogger(this.getClass().getName());

  private final OcOrderStatusDao dao;

  @Inject
  protected OcOrderStatusServiceImpl(final OcOrderStatusDao dao) {
      requireNonNull(dao);
      this.dao = dao;
  }
  ...
  public List<OcOrderStatus> selectAll() {
      final List<OcOrderStatus> result = dao.selectAll();
      logger.info("selectAll(OcOrderStatus) - exited - return value={} result ");
      return result;
  }
  ...
  @Override
  @Transactional
  public void delete(OcOrderStatus bean) {
    logger.info("delete(OcOrderStatus={}) - entered bean");

    dao.delete(bean);

    logger.info("delete(OcOrderStatus) - exited - return value={} result ");
  }
}