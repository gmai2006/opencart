...
public class ModelLocalisationLanguageResource {
  private final static Logger logger = Logger.getLogger(ModelLocalisationLanguageResource.class.getName());

  private final ModelLocalisationLanguageService service;

  @Inject
  protected ModelLocalisationLanguageResource(final ModelLocalisationLanguageService service) {
  ...
  //TODO
    return service.getLanguage(language_id);
  }
