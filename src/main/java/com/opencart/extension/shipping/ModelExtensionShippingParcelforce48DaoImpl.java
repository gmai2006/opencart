...
*/
public class ModelExtensionShippingParcelforce48DaoImpl implements ModelExtensionShippingParcelforce48Dao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionShippingParcelforce48DaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionShippingParcelforce48.getQuote.getQuote
  ...
  public List<OcZoneToGeoZone> getQuote(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionShippingParcelforce48.getQuote.getQuote");
