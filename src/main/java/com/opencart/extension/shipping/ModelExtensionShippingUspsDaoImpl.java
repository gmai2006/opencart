...
*/
public class ModelExtensionShippingUspsDaoImpl implements ModelExtensionShippingUspsDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionShippingUspsDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionShippingUsps.getQuote.getQuote
  ...
  public List<OcZoneToGeoZone> getQuote(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionShippingUsps.getQuote.getQuote");
