...
*/
public class ModelExtensionShippingFlatDaoImpl implements ModelExtensionShippingFlatDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionShippingFlatDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionShippingFlat.getQuote.getQuote
  ...
  public List<OcZoneToGeoZone> getQuote(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionShippingFlat.getQuote.getQuote");
