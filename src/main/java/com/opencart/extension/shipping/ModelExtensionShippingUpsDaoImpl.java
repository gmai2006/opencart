...
*/
public class ModelExtensionShippingUpsDaoImpl implements ModelExtensionShippingUpsDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionShippingUpsDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionShippingUps.getQuote.getQuote
  ...
  public List<OcZoneToGeoZone> getQuote(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionShippingUps.getQuote.getQuote");
