...
*/
public class ModelExtensionShippingFreeDaoImpl implements ModelExtensionShippingFreeDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionShippingFreeDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionShippingFree.getQuote.getQuote
  ...
  public List<OcZoneToGeoZone> getQuote(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionShippingFree.getQuote.getQuote");
