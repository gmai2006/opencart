...
*/
public class ModelExtensionOpenBayEbayOpenbayDaoImpl implements ModelExtensionOpenBayEbayOpenbayDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionOpenBayEbayOpenbayDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  public List<OcCountry> updateOrderWithConfirmedData(String iso_code_2) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionOpenBayEbayOpenbay.updateOrderWithConfirmedData.updateOrderWithConfirmedData");
