...
public class ModelExtensionOpenBayAmazonOrder0Dto implements Serializable {
  private final static Logger logger = Logger.getLogger(ModelExtensionOpenBayAmazonOrder0Dto.class.getName());
  ...
  public static ModelExtensionOpenBayAmazonOrder0Dto fromArray(Object[] o) {
    ModelExtensionOpenBayAmazonOrder0Dto result = new ModelExtensionOpenBayAmazonOrder0Dto();
    int i = 0;
