...
*/
public class ModelExtensionPaymentPPPayflowIframeDaoImpl implements ModelExtensionPaymentPPPayflowIframeDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentPPPayflowIframeDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionPaymentPPPayflowIframe.getMethod.getMethod
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentPPPayflowIframe.getMethod.getMethod");
