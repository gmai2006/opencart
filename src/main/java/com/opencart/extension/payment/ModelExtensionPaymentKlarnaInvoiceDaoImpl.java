...
*/
public class ModelExtensionPaymentKlarnaInvoiceDaoImpl implements ModelExtensionPaymentKlarnaInvoiceDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentKlarnaInvoiceDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionPaymentKlarnaInvoice.getMethod.getMethod
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentKlarnaInvoice.getMethod.getMethod");
