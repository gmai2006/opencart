...
*/
public class ModelExtensionPaymentGlobalpayRemoteDaoImpl implements ModelExtensionPaymentGlobalpayRemoteDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentGlobalpayRemoteDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionPaymentGlobalpayRemote.getMethod.getMethod
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentGlobalpayRemote.getMethod.getMethod");
