...
*/
public class ModelExtensionPaymentSecureTradingWsDaoImpl implements ModelExtensionPaymentSecureTradingWsDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentSecureTradingWsDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionPaymentSecureTradingWs.getMethod.getMethod
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentSecureTradingWs.getMethod.getMethod");
