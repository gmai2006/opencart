...
*/
public class ModelExtensionPaymentSecureTradingPpDaoImpl implements ModelExtensionPaymentSecureTradingPpDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentSecureTradingPpDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionPaymentSecureTradingPp.getMethod.getMethod
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentSecureTradingPp.getMethod.getMethod");
