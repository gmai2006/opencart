...
*/
public class ModelExtensionPaymentAuthorizeNetAimDaoImpl implements ModelExtensionPaymentAuthorizeNetAimDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentAuthorizeNetAimDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionPaymentAuthorizeNetAim.getMethod.getMethod
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentAuthorizeNetAim.getMethod.getMethod");
