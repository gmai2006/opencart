...
*/
public class ModelExtensionPaymentBluePayRedirectDaoImpl implements ModelExtensionPaymentBluePayRedirectDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentBluePayRedirectDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentBluePayRedirect.getMethod.getMethod");
