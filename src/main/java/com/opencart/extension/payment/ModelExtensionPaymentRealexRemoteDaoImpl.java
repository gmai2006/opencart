...
*/
public class ModelExtensionPaymentRealexRemoteDaoImpl implements ModelExtensionPaymentRealexRemoteDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentRealexRemoteDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionPaymentRealexRemote.getMethod.getMethod
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentRealexRemote.getMethod.getMethod");
