...
*/
public class ModelExtensionPaymentTwoCheckoutDaoImpl implements ModelExtensionPaymentTwoCheckoutDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentTwoCheckoutDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionPaymentTwoCheckout.getMethod.getMethod
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentTwoCheckout.getMethod.getMethod");
