...
*/
public class ModelExtensionPaymentEwayDaoImpl implements ModelExtensionPaymentEwayDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentEwayDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionPaymentEway.getMethod.getMethod
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentEway.getMethod.getMethod");
