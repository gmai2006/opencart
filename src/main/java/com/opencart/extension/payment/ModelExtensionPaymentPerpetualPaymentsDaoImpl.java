...
*/
public class ModelExtensionPaymentPerpetualPaymentsDaoImpl implements ModelExtensionPaymentPerpetualPaymentsDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentPerpetualPaymentsDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionPaymentPerpetualPayments.getMethod.getMethod
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentPerpetualPayments.getMethod.getMethod");
