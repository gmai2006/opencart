...
*/
public class ModelExtensionPaymentBluePayHostedDaoImpl implements ModelExtensionPaymentBluePayHostedDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentBluePayHostedDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentBluePayHosted.getMethod.getMethod");
