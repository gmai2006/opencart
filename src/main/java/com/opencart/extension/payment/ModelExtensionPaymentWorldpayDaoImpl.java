...
*/
public class ModelExtensionPaymentWorldpayDaoImpl implements ModelExtensionPaymentWorldpayDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentWorldpayDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionPaymentWorldpay.getProfile.getProfile
  ...
  public List<OcOrderRecurring> getProfile(Integer order_recurring_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentWorldpay.getProfile.getProfile");
  ...
  /* *
   * ModelExtensionPaymentWorldpay.getMethod.getMethod
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentWorldpay.getMethod.getMethod");
