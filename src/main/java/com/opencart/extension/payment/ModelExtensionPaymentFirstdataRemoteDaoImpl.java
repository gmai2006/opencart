...
*/
public class ModelExtensionPaymentFirstdataRemoteDaoImpl implements ModelExtensionPaymentFirstdataRemoteDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentFirstdataRemoteDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentFirstdataRemote.getMethod.getMethod");
