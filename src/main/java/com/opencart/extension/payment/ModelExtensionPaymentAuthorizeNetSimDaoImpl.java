...
*/
public class ModelExtensionPaymentAuthorizeNetSimDaoImpl implements ModelExtensionPaymentAuthorizeNetSimDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentAuthorizeNetSimDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionPaymentAuthorizeNetSim.getMethod.getMethod
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentAuthorizeNetSim.getMethod.getMethod");
