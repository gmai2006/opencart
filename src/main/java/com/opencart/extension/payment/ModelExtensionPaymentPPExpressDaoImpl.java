...
*/
public class ModelExtensionPaymentPPExpressDaoImpl implements ModelExtensionPaymentPPExpressDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentPPExpressDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentPPExpress.getMethod.getMethod");
