...
*/
public class ModelExtensionPaymentCardConnectDaoImpl implements ModelExtensionPaymentCardConnectDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentCardConnectDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentCardConnect.getMethod.getMethod");
