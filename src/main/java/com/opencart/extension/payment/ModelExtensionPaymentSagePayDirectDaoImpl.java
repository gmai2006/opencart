...
*/
public class ModelExtensionPaymentSagePayDirectDaoImpl implements ModelExtensionPaymentSagePayDirectDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentSagePayDirectDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionPaymentSagePayDirect.getMethod.getMethod
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentSagePayDirect.getMethod.getMethod");
  ...
  /* *
   * ModelExtensionPaymentSagePayDirect.getProfile.getProfile
  ...
  public List<OcOrderRecurring> getProfile(Integer order_recurring_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentSagePayDirect.getProfile.getProfile");
