...
*/
public class ModelExtensionPaymentWebPaymentSoftwareDaoImpl implements ModelExtensionPaymentWebPaymentSoftwareDao {
  private final Provider<EntityManager> entityManagerProvider;

  @Inject
  protected ModelExtensionPaymentWebPaymentSoftwareDaoImpl(final Provider<EntityManager> entityManagerProvider) {
  ...
  /* *
   * ModelExtensionPaymentWebPaymentSoftware.getMethod.getMethod
  ...
  public List<OcZoneToGeoZone> getMethod(Integer geo_zone_id,Integer country_id) {
    ...
    final String queryName = DaoUtils.getQuery("ModelExtensionPaymentWebPaymentSoftware.getMethod.getMethod");
