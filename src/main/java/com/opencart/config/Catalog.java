...
public class Catalog  {
  ...
  static {
    ...
    insert("library_autoload", "openbay");
    insert("action_pre_action", "startup/session");
    insert("action_pre_action", "startup/startup");
    insert("action_pre_action", "startup/error");
    insert("action_pre_action", "startup/event");
    insert("action_pre_action", "startup/maintenance");
    insert("action_pre_action", "startup/seo_url");
