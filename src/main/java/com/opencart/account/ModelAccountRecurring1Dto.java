...
public class ModelAccountRecurring1Dto implements Serializable {
  private final static Logger logger = Logger.getLogger(ModelAccountRecurring1Dto.class.getName());
  ...
  public static ModelAccountRecurring1Dto fromArray(Object[] o) {
    ModelAccountRecurring1Dto result = new ModelAccountRecurring1Dto();
    int i = 0;
