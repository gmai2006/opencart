...
public class ModelAccountTransactionResource {
  private final static Logger logger = Logger.getLogger(ModelAccountTransactionResource.class.getName());

  private final ModelAccountTransactionService service;

  @Inject
  protected ModelAccountTransactionResource(final ModelAccountTransactionService service) {
  ...
  //TODO
    return service.getTotalTransactions(customer_id);
  }
  ...
  //Normally no business logic should in RESTful but may be form validation can be here
  //TODO
    return service.getTotalAmount(customer_id);
  }
}