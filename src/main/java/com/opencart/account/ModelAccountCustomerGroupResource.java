...
public class ModelAccountCustomerGroupResource {
  private final static Logger logger = Logger.getLogger(ModelAccountCustomerGroupResource.class.getName());

  private final ModelAccountCustomerGroupService service;

  @Inject
  protected ModelAccountCustomerGroupResource(final ModelAccountCustomerGroupService service) {
  ...
  //TODO
    return service.getCustomerGroup(customer_group_id,language_id);
  }
  ...
  //Normally no business logic should in RESTful but may be form validation can be here
  //TODO
    return service.getCustomerGroups(language_id);
  }
}