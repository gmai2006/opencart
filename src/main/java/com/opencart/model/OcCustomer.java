...
public class OcCustomer  {
  ...
  public static OcCustomer fromJson(JsonObject o) {
    Gson gson = new GsonBuilder()
           .setDateFormat("yyyy-MM-dd").create();
      return gson.fromJson(o, OcCustomer.class);
    }

  public static OcCustomer fromArray(Object[] o) {
      OcCustomer result = new OcCustomer();
      int i = 0;
        result.setStoreId((Integer)BeanUtils.getNullableValue(o[i++]));
        result.setNewsletter((Boolean)BeanUtils.getNullableValue(o[i++]));
        ...
        result.setWishlist((String)BeanUtils.getNullableValue(o[i++]));
        ...
        result.setCart((String)BeanUtils.getNullableValue(o[i++]));
        ...
        result.setSafe((Boolean)BeanUtils.getNullableValue(o[i++]));
  ...
  public static JsonArray toJsonArray(List<OcCustomer> list) {
      JsonArray array = new JsonArray();
      for (OcCustomer dao : list) {
