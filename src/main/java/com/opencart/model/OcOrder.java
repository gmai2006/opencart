...
public class OcOrder  {
  ...
  public static OcOrder fromJson(JsonObject o) {
    Gson gson = new GsonBuilder()
           .setDateFormat("yyyy-MM-dd").create();
      return gson.fromJson(o, OcOrder.class);
    }

  public static OcOrder fromArray(Object[] o) {
      OcOrder result = new OcOrder();
      int i = 0;
        result.setPaymentZoneId((Integer)BeanUtils.getNullableValue(o[i++]));
        result.setShippingCode((String)BeanUtils.getNullableValue(o[i++]));
        result.setAffiliateId((Integer)BeanUtils.getNullableValue(o[i++]));
        result.setShippingCity((String)BeanUtils.getNullableValue(o[i++]));
        result.setShippingAddress1((String)BeanUtils.getNullableValue(o[i++]));
        result.setOrderStatusId((Integer)BeanUtils.getNullableValue(o[i++]));
        result.setShippingAddress2((String)BeanUtils.getNullableValue(o[i++]));
        result.setLanguageId((Integer)BeanUtils.getNullableValue(o[i++]));
        result.setTracking((String)BeanUtils.getNullableValue(o[i++]));
        result.setShippingAddressFormat((String)BeanUtils.getNullableValue(o[i++]));
        result.setPaymentLastname((String)BeanUtils.getNullableValue(o[i++]));
        result.setForwardedIp((String)BeanUtils.getNullableValue(o[i++]));
        result.setShippingMethod((String)BeanUtils.getNullableValue(o[i++]));
        result.setAcceptLanguage((String)BeanUtils.getNullableValue(o[i++]));
        result.setPaymentPostcode((String)BeanUtils.getNullableValue(o[i++]));
        result.setFax((String)BeanUtils.getNullableValue(o[i++]));
        result.setPaymentMethod((String)BeanUtils.getNullableValue(o[i++]));
        result.setShippingLastname((String)BeanUtils.getNullableValue(o[i++]));
        result.setPaymentCustomField((String)BeanUtils.getNullableValue(o[i++]));
        result.setShippingCompany((String)BeanUtils.getNullableValue(o[i++]));
        result.setInvoicePrefix((String)BeanUtils.getNullableValue(o[i++]));
        result.setPaymentZone((String)BeanUtils.getNullableValue(o[i++]));
        result.setIp((String)BeanUtils.getNullableValue(o[i++]));
        result.setTelephone((String)BeanUtils.getNullableValue(o[i++]));
        result.setPaymentCountryId((Integer)BeanUtils.getNullableValue(o[i++]));
        ...
        result.setShippingCountry((String)BeanUtils.getNullableValue(o[i++]));
        result.setFirstname((String)BeanUtils.getNullableValue(o[i++]));
        result.setPaymentAddressFormat((String)BeanUtils.getNullableValue(o[i++]));
        result.setCurrencyCode((String)BeanUtils.getNullableValue(o[i++]));
        result.setStoreUrl((String)BeanUtils.getNullableValue(o[i++]));
        result.setTotal((Long)BeanUtils.getNullableValue(o[i++]));
        result.setShippingCountryId((Integer)BeanUtils.getNullableValue(o[i++]));
        result.setPaymentCountry((String)BeanUtils.getNullableValue(o[i++]));
        result.setStoreName((String)BeanUtils.getNullableValue(o[i++]));
        result.setCommission((Long)BeanUtils.getNullableValue(o[i++]));
        result.setShippingFirstname((String)BeanUtils.getNullableValue(o[i++]));
        result.setPaymentCity((String)BeanUtils.getNullableValue(o[i++]));
        result.setShippingPostcode((String)BeanUtils.getNullableValue(o[i++]));
        result.setShippingCustomField((String)BeanUtils.getNullableValue(o[i++]));
        result.setEmail((String)BeanUtils.getNullableValue(o[i++]));
        result.setPaymentFirstname((String)BeanUtils.getNullableValue(o[i++]));
        result.setUserAgent((String)BeanUtils.getNullableValue(o[i++]));
        result.setPaymentCompany((String)BeanUtils.getNullableValue(o[i++]));
        result.setPaymentCode((String)BeanUtils.getNullableValue(o[i++]));
        result.setStoreId((Integer)BeanUtils.getNullableValue(o[i++]));
        result.setCustomField((String)BeanUtils.getNullableValue(o[i++]));
        result.setInvoiceNo((Integer)BeanUtils.getNullableValue(o[i++]));
        result.setCurrencyValue((Long)BeanUtils.getNullableValue(o[i++]));
        result.setPaymentAddress2((String)BeanUtils.getNullableValue(o[i++]));
        result.setPaymentAddress1((String)BeanUtils.getNullableValue(o[i++]));
        ...
        result.setShippingZone((String)BeanUtils.getNullableValue(o[i++]));
        ...
        result.setShippingZoneId((Integer)BeanUtils.getNullableValue(o[i++]));
        result.setCurrencyId((Integer)BeanUtils.getNullableValue(o[i++]));
      return result;
    }

  public static JsonArray toJsonArray(List<OcOrder> list) {
      JsonArray array = new JsonArray();
      for (OcOrder dao : list) {
