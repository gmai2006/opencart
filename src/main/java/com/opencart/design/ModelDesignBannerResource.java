...
public class ModelDesignBannerResource {
  private final static Logger logger = Logger.getLogger(ModelDesignBannerResource.class.getName());

  private final ModelDesignBannerService service;

  @Inject
  protected ModelDesignBannerResource(final ModelDesignBannerService service) {
  ...
  //TODO
    return service.getBanner(banner_id,language_id);
  }
}