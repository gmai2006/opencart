...
public class ModelDesignThemeResource {
  private final static Logger logger = Logger.getLogger(ModelDesignThemeResource.class.getName());

  private final ModelDesignThemeService service;

  @Inject
  protected ModelDesignThemeResource(final ModelDesignThemeService service) {
  ...
  //TODO
    return service.getTheme(store_id,theme,route);
  }
}