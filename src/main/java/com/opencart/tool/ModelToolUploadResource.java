...
public class ModelToolUploadResource {
  private final static Logger logger = Logger.getLogger(ModelToolUploadResource.class.getName());

  private final ModelToolUploadService service;

  @Inject
  protected ModelToolUploadResource(final ModelToolUploadService service) {
  ...
  //TODO
    return service.getUploadByCode(code);
  }
}